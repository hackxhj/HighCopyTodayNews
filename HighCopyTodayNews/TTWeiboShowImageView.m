...
@implementation TTWeiboShowImageView{
...
- (void)configScrollViewWith:(NSInteger)clickTag andAppendArray:(NSArray *)appendArray{
    ...
    for (int i = 0; i < appendArray.count; i ++) {
        ...
        // imageView.image = img;
        [imageView sd_setImageWithURL:[NSURL URLWithString:[appendArray objectAtIndex:i]] placeholderImage:[UIImage imageNamed:@"details_slogan02"]];
